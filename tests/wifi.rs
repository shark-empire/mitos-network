...
fn best_bss_picks_strongest_signal_for_ssid() {
    let nets = vec![
        net("HomeNet", "aa:aa:aa:aa:aa:aa", -70),
        net("HomeNet", "bb:bb:bb:bb:bb:bb", -40),
        net("OtherNet", "cc:cc:cc:cc:cc:cc", -20),
    ];
...
fn roaming_hysteresis_prevents_ping_pong() {
    ...
    let nets = vec![
        net("HomeNet", "aa:aa:aa:aa:aa:aa", -50),
        net("HomeNet", "bb:bb:bb:bb:bb:bb", -47),
    ];
    ...
    let nets_strong = vec![
        net("HomeNet", "aa:aa:aa:aa:aa:aa", -70),
        net("HomeNet", "bb:bb:bb:bb:bb:bb", -55),
    ];
